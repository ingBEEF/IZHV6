    ...
    private void MainWindowUI(int windowId)
    {
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                // SoundManager.Instance.masterMuted = GUILayout.Toggle(SoundManager.Instance.masterMuted, "Mute Sound");
                var newMuted = GUILayout.Toggle(SoundManager.Instance.masterMuted, "Mute Sound");
                if (newMuted != SoundManager.Instance.masterMuted)
                {
